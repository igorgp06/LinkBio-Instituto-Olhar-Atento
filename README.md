# LinkBio Instituto Olhar Atento

Um web site desenvolvido para o Instituto Olhar Atento, dedicada a apoiar crianças e adolescentes em situação de vulnerabilidade social. O site serve como uma plataforma para reunir informações sobre o instituto, seus projetos e formas de contato e todas as suas redes sociais em um único local.    
...
- **Código-fonte, estrutura técnica e documentação:** propriedade de [Igor Gonçalves | DEV](https://igdeveloper.com.br).  
- **Conteúdos fornecidos (imagens, textos, logotipos, etc.):** propriedade exclusiva do Instituto Olhar Atento.  

Este repositório é disponibilizado apenas para fins de visualização e aprendizado, sendo proibida sua modificação, redistribuição ou uso comercial sem autorização expressa dos respectivos titulares.
